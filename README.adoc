...
link:https://htmlpreview.github.io/?https://github.com/IUT-Blagnac/r5-a-08-qualdev-NolanJacquemont/tree/main/resources/pgn-checker-sucess/serenity/site/index.html[lien vers la page HTML Serenity du projet PgnChecker (réussite)]

.Serenity pour le projet PgnChecker (échec)
link:https://htmlpreview.github.io/?https://github.com/IUT-Blagnac/r5-a-08-qualdev-NolanJacquemont/tree/main/resources/pgn-checker-error/serenity/site/index.html[lien vers la page HTML Serenity du projet PgnChecker (échec)]